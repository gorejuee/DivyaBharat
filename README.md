...
An AI-powered Indian spiritual and heritage travel companion. DivyaBharat helps travelers discover temples, forts, caves, ghats, ashrams and other heritage sites across India - with rich historical context, an AI guide, and a full trip planner powered by AI.
...
│   └── src/
│       ├── views/          # Home, Places, PlaceDetail, MapView, TripDetail, MyTrips, ...
│       ├── components/     # PlaceCard, ...
│       ├── router/
│       ├── stores/         # user.js, trips.js
│       ├── services/
│       └── utils/
│
└── divyabharat-backend/
    ├── config/
    ├── controllers/        # placesController, tripController, aiController, ...
    ├── jobs/
    ├── middlewares/
    ├── migrations/
    ├── models/             # User, Place, Trip, TripPlace, UserPlace, AiGuideCache
    ├── routes/             # auth, places, trips, visits, ai, admin
    ├── seeders/
    ├── services/
    ├── db.js
    └── server.js
