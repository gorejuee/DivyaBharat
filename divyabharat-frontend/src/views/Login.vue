  ...
  <div class="auth-root">
    ...
    <div class="auth-card">
      ...
      <div class="auth-header">
        ...
        <p class="auth-sub font-body">Sign in to continue your sacred journey</p>
      </div>
      ...
      <div class="auth-body">
        <v-form ref="form">
          ...
          <button type="button" class="auth-submit-btn font-label" @click="login">
            Sign In
          </button>
        </v-form>
        ...
        <p class="auth-footer-text font-body">
          ...
          <router-link to="/register" class="auth-footer-link">Join DivyaBharat</router-link>
        </p>
      </div>
    </div>
  </div>
